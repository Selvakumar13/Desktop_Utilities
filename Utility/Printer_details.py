...
class PrinterValidationApp(QMainWindow):
    ...
    def get_number_of_pages_info(self, printer_name):
            ...
            file_name = 'Printer_pages_log.json'

            # Create the full path to your temporary file
            ...
            if os.path.exists(log_file_path) :
                ...
                return "Failed to read JSON data from the file or printer not found."
...
if __name__ == "__main__":
    temp_dir = tempfile.gettempdir()
    file_name = 'PCP_printer_count_log.json'
    # Create the full path to your temporary file
    log_file_path = os.path.join(temp_dir, file_name)
    ...
    # Get the path to the directory where python.exe is located
