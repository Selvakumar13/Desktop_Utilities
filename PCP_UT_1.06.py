import sys
from PySide6.QtWidgets import QApplication, QMainWindow, QVBoxLayout, QWidget, QFrame, QMenu, QMessageBox, QSystemTrayIcon
...
class DesktopUtilityApp(QMainWindow):
    def __init__(self):
        ...
        self.tray_icon.activated.connect(lambda reason : self.open_pcp_app() if reason == QSystemTrayIcon.ActivationReason.DoubleClick else None)
